...
#define DRAW_SPHERE_SINGLE_FRAME(Location)	if (GetWorld()) { DrawDebugSphere(GetWorld(), Location, 25.f, 12, FColor::Blue); }
...
#define DRAW_POINT_SINGLE_FRAME(Location)	if (GetWorld()) { DrawDebugPoint(GetWorld(), Location, 15.f, FColor::Red); }
